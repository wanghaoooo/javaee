    ...
    <div class="tpl-left-nav tpl-left-nav-hover">
        ...
        <div class="tpl-left-nav-list">
            <ul class="tpl-left-nav-menu">
                ...
                <li class="tpl-left-nav-item">
                    <a href="homework.jsp" class="nav-link active">
                        <span>老师作业布置</span>
                    </a>
                </li>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>已布置的作业列表
                </div>
                ...
                <div class="am-g">
                    <div class="am-u-sm-12 am-u-md-6">
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <button type="button" class="am-btn am-btn-default am-btn-success" onclick="window.location.href='addhomework.jsp'"><span class="am-icon-plus"></span> 新增</button>
                    ...
                    <div class="am-u-sm-12 am-u-md-3">
                        <div class="am-input-group am-input-group-sm">
                            <input type="text" class="am-form-field" placeholder="要查询的作业号" id="key" onkeydown="onSearch(this)" >
            ...
            ></button>
                ...
                <script type="text/javascript">
                    window.onload = function () {
                        ...
                        for (var i=4, length=btns.length; i<=length; i++) {
                            var btn = btns[i];
                            //将btn所对应的下标保存在btn上
                            btn.index = i;
                            if(i%2==0){
                                btn.onclick = function () {
                                    window.localStorage.setItem('user',this.index+1);
                                    alert('第'+(this.index+1)+'个');
                                    window.location.href="/editKH";

                                };
                            }
                            else {
                                btn.onclick = function (){
                                    window.localStorage.setItem('user1',this.index+1);
                                    alert('第'+(this.index+1)+'个');
                                    window.location.href="/deleteKH";
                                };
                            }
                        }
                    }
